...
// This file handles all API routes through a single function
...
// Create centralized JSON response helper
const json = (data, success = true, status = 200) => {
...
app.post('/projects', async (c) => {
  try {
    ...
    return json(newProject, true, 201);
  } catch (err) {
